...
public interface UserRepository extends CrudRepository<User, Integer> {
    ...
    // public List<User> findAllUserByFriends(User user); // Have to think about
    // this. Will it give what we want?

    // public List<User> findAllUserByInvitee(InvitationDestination
